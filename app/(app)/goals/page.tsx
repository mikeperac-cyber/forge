              ...
              {active.map((goal) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <GoalStatusButton goalId={goal.id} status="done" label="Done" />
                  </div>
                  ...
                  <div className="mt-2.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11.5px] text-ink-faint">
                ...
                <li className="pt-4">
                  ...
                  <ul className="mt-1.5 space-y-1">
                    {finished.map((goal) => (
                      ...
                      >
                        <Icon name="CircleCheck" className="size-3.5 text-ok" />
                        <span className="min-w-0 flex-1 truncate text-[13px] text-ink-soft line-through decoration-line">
                          {goal.title}
                        </span>
                        <span
